      ...
      <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleDragEnd} modifiers={[restrictToHorizontalAxis]}>
        <SortableContext items={accountIds} strategy={horizontalListSortingStrategy}>
          ...
          <div ref={scrollContainerRef} className="flex gap-4 pb-4 overflow-x-auto hide-scrollbar-mobile scroll-smooth">
            ...
            {orderedSummaries.length === 0 && <div className="w-[280px] p-6 md:p-8 border-2 border-dashed border-border rounded-xl flex flex-col items-center justify-center gap-3 text-muted-foreground">
