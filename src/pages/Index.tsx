...
const Index = () => {
  ...
  const totalDividasV2 = totalDividas;
  const liquidezRatio = totalDividasV2 > 0 ? totalAtivosPeriodo / totalDividasV2 : 999;
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <span className="text-xs font-bold tracking-wide text-primary uppercase">
                {dateRanges.range1.from ? format(dateRanges.range1.from, 'MMMM yyyy', { locale: ptBR }) : 'Selecione o Período'}
              </span>
